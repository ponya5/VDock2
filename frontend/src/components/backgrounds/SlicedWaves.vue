<template>
  <div ref="rootEl" class="sliced-waves-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev SlicedWaves. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountSlicedWaves(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountSlicedWaves(rootEl, canvasEl, hooks, {
  color1 = '#FF9FFC',
  color2 = '#5227FF',
  color3 = '#B497CF',
  columns = 14,
