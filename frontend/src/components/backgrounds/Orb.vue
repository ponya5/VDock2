<template>
  <div ref="rootEl" class="orb-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev Orb. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountOrb(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountOrb(rootEl, canvasEl, hooks, {
  hue = 0,
  hoverIntensity = 0.2,
  rotateOnHover = true,
