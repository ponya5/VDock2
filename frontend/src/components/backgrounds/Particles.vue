<template>
  <div ref="rootEl" class="particles-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev Particles. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountParticles(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountParticles(rootEl, canvasEl, hooks, {
  particleCount = 200,
  particleSpread = 10,
  speed = 0.1,
  particleColors,
