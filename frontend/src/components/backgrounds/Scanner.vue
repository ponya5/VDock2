<template>
  <div ref="rootEl" class="scanner-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev Scanner. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountScanner(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountScanner(rootEl, canvasEl, hooks, {
  color1 = '#5227FF',
  color2 = '#FF9FFC',
  color3 = '#FFFFFF',
  speed = 0.5,
