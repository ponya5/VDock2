<template>
  <div ref="rootEl" class="liquidChrome-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev LiquidChrome. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountLiquidChrome(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountLiquidChrome(rootEl, canvasEl, hooks, {
