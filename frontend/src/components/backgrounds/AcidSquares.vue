<template>
  <div ref="rootEl" class="acid-squares-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev AcidSquares. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountAcidSquares(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountAcidSquares(rootEl, canvasEl, hooks, {
  color1 = '#5227FF',
  color2 = '#A855F7',
  color3 = '#FFFFFF',
  detail = 'medium',
