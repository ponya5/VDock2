<template>
  <div ref="rootEl" class="ferrofluid-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev Ferrofluid. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountFerrofluid(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountFerrofluid(rootEl, canvasEl, hooks, {
  className,
  dpr,
  paused = false,
