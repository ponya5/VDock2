<template>
  <div ref="rootEl" class="galaxy-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev Galaxy. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountGalaxy(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountGalaxy(rootEl, canvasEl, hooks, {
  focal = [0.5, 0.5],
  rotation = [1.0, 0.0],
  starSpeed = 0.5,
  density = 1,
