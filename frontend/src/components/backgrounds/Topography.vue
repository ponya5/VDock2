<template>
  <div ref="rootEl" class="topography-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev Topography. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountTopography(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountTopography(rootEl, canvasEl, hooks, {
  lowColor = '#5227FF',
  midColor = '#FF9FFC',
  highColor = '#FFFFFF',
  speed = 0.35,
