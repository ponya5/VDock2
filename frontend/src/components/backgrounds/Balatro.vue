<template>
  <div ref="rootEl" class="balatro-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev Balatro. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountBalatro(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountBalatro(rootEl, canvasEl, hooks, {
  spinRotation = -2.0,
  spinSpeed = 7.0,
  offset = [0.0, 0.0],
  color1 = '#DE443B',
