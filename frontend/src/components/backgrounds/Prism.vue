<template>
  <div ref="rootEl" class="prism-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev Prism. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountPrism(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountPrism(rootEl, canvasEl, hooks, {
  height = 3.5,
  baseWidth = 5.5,
