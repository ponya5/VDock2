<template>
  <div ref="rootEl" class="web-threads-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev WebThreads. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountWebThreads(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountWebThreads(rootEl, canvasEl, hooks, {
  color1 = '#5227FF',
  color2 = '#FF9FFC',
  color3 = '#FFFFFF',
  speed = 0.2,
