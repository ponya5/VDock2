<template>
  <div ref="rootEl" class="grainient-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev Grainient. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountGrainient(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountGrainient(rootEl, canvasEl, hooks, {
  timeSpeed = 0.25,
  colorBalance = 0.0,
  warpStrength = 1.0,
  warpFrequency = 5.0,
