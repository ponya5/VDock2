<template>
  <div ref="rootEl" class="ripple-grid-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev RippleGrid. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountRippleGrid(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountRippleGrid(rootEl, canvasEl, hooks, {
  enableRainbow = false,
  gridColor = '#ffffff',
