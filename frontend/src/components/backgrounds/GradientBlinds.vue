<template>
  <div ref="rootEl" class="gradient-blinds-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev GradientBlinds. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountGradientBlinds(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountGradientBlinds(rootEl, canvasEl, hooks, {
  className,
  dpr,
  paused = false,
  gradientColors,
