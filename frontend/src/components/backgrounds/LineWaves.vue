<template>
  <div ref="rootEl" class="line-waves-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev LineWaves. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountLineWaves(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountLineWaves(rootEl, canvasEl, hooks, {
  speed = 0.3,
  innerLineCount = 32.0,
  outerLineCount = 36.0,
  warpIntensity = 1.0,
