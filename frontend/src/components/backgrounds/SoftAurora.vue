<template>
  <div ref="rootEl" class="soft-aurora-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev SoftAurora. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountSoftAurora(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountSoftAurora(rootEl, canvasEl, hooks, {
  speed = 0.6,
  scale = 1.5,
  brightness = 1.0,
  color1 = '#f7f7f7',
