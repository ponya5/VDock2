<template>
  <div ref="rootEl" class="light-tunnel-container" aria-hidden="true" />
</template>

<script setup>
// Ported from reactbits.dev LightTunnel. The renderer internals are kept verbatim
...
onMounted(() => {
  ...
  cleanup = mountLightTunnel(rootEl.value, null, hooks, { onError: props.onError })
})
...
function mountLightTunnel(rootEl, canvasEl, hooks, {
  cableColor = '#A855F7',
  pulseColor = '#A855F7',
  tunnelColor = '#5227FF',
  tunnelOpacity = 0,
