...
const aiAssistants: AppTemplate[] = [
  ...
  { id: "manus", name: "Manus", description: "Manus AI agent shortcuts", icon: ["fas","robot"], logo: "/logos/manus.png", color: "#6c63ff", buttons: [
...
const aiCoding: AppTemplate[] = [
  ...
  { id: "cline", name: "Cline", description: "Cline AI coding assistant shortcuts", icon: ["fas","terminal"], logo: "/logos/cline.png", color: "#7c3aed", buttons: [
  ...
  { id: "kilo-code", name: "Kilo Code", description: "Kilo Code AI assistant shortcuts", icon: ["fas","code"], logo: "/logos/kilocode.png", color: "#0ea5e9", buttons: [
  ...
  { id: "codex", name: "Codex", description: "OpenAI Codex CLI shortcuts", icon: ["fas","terminal"], logo: "/logos/codex-color.png", color: "#10a37f", buttons: [
  ...
  { id: "openclaw", name: "OpenClaw", description: "OpenClaw AI shortcuts", icon: ["fas","robot"], logo: "/logos/openclaw-color.png", color: "#f59e0b", buttons: [
...
const aiImageVideo: AppTemplate[] = [
  { id: "midjourney", name: "Midjourney", description: "Midjourney image generation shortcuts", icon: ["fas","image"], logo: "/logos/midjourney.png", color: "#000000", buttons: [
  ...
  { id: "ideogram", name: "Ideogram", description: "Ideogram AI image shortcuts", icon: ["fas","image"], logo: "/logos/ideogram.png", color: "#6366f1", buttons: [
  ...
  { id: "recraft", name: "Recraft", description: "Recraft AI design shortcuts", icon: ["fas","pen-nib"], logo: "/logos/recraft.png", color: "#f43f5e", buttons: [
  ...
  { id: "flux", name: "Flux", description: "Black Forest Labs Flux shortcuts", icon: ["fas","image"], logo: "/logos/flux.png", color: "#0f172a", buttons: [
  ...
  { id: "sora", name: "Sora", description: "OpenAI Sora video generation", icon: ["fas","video"], logo: "/logos/sora-color.png", color: "#10a37f", buttons: [
  ...
  { id: "runway", name: "Runway", description: "Runway ML video generation shortcuts", icon: ["fas","film"], logo: "/logos/runway.png", color: "#1a1a2e", buttons: [
  ...
  { id: "lightricks", name: "Lightricks", description: "Lightricks AI creative tools", icon: ["fas","wand-magic-sparkles"], logo: "/logos/lightricks.png", color: "#ff6b6b", buttons: [
  ...
  { id: "minimax", name: "MiniMax", description: "MiniMax AI video generation", icon: ["fas","video"], logo: "/logos/minimax-color.png", color: "#7c3aed", buttons: [
    { label: "Open MiniMax", icon: ["fas","arrow-up-right-from-square"], action: url("https://hailuoai.video"), tooltip: "Open MiniMax" },
  ]},
  { id: "suno", name: "Suno", description: "Suno AI music generation", icon: ["fas","music"], logo: "/logos/suno.png", color: "#f59e0b", buttons: [
...
const designCreative: AppTemplate[] = [
  { id: "figma", name: "Figma", description: "Figma design shortcuts", icon: ["fab","figma"], logo: "/logos/figma-color.png", color: "#f24e1e", buttons: [
  ...
  { id: "adobe-cc", name: "Adobe CC", description: "Adobe Creative Cloud shortcuts", icon: ["fas","palette"], logo: "/logos/adobe-color.png", color: "#ff0000", buttons: [
  ...
  { id: "v0", name: "v0", description: "Vercel v0 UI generation shortcuts", icon: ["fas","code"], logo: "/logos/v0.png", color: "#000000", buttons: [
...
const automationDev: AppTemplate[] = [
  { id: "n8n", name: "n8n", description: "n8n workflow automation shortcuts", icon: ["fas","diagram-project"], logo: "/logos/n8n-color.png", color: "#ea4b71", buttons: [
  ...
  { id: "zapier", name: "Zapier", description: "Zapier automation shortcuts", icon: ["fas","bolt"], logo: "/logos/zapier-color.png", color: "#ff4a00", buttons: [
  ...
  { id: "github", name: "GitHub", description: "GitHub shortcuts", icon: ["fab","github"], logo: "/logos/github.png", color: "#24292e", buttons: [
  ...
  { id: "crewai", name: "CrewAI", description: "CrewAI multi-agent framework shortcuts", icon: ["fas","users"], logo: "/logos/crewai-color.png", color: "#e11d48", buttons: [
  ...
  { id: "langgraph", name: "LangGraph", description: "LangGraph agent framework shortcuts", icon: ["fas","diagram-project"], logo: "/logos/langgraph-color.png", color: "#1c7ed6", buttons: [
  ...
  { id: "aws-bedrock", name: "AWS Bedrock", description: "AWS Bedrock AI shortcuts", icon: ["fab","aws"], logo: "/logos/bedrock-color.png", color: "#ff9900", buttons: [
...
const aiPlatforms: AppTemplate[] = [
  { id: "huggingface", name: "HuggingFace", description: "HuggingFace platform shortcuts", icon: ["fas","robot"], logo: "/logos/huggingface-color.png", color: "#ff9d00", buttons: [
  ...
  { id: "ollama", name: "Ollama", description: "Ollama local LLM shortcuts", icon: ["fas","server"], logo: "/logos/ollama.png", color: "#1a1a1a", buttons: [
